      ...
      <div className="relative">
        <header className="grid grid-cols-[auto_1fr_auto] items-center gap-3 overflow-hidden rounded-2xl bg-[#181818] px-4 py-3">
          ...
          <a
            ...
            className="grid h-12 w-12 place-items-center rounded-[12px] bg-[linear-gradient(140deg,#a08ade_8%,#7c54b5_42%,#6e54b5_93%)] text-white transition-all duration-150 hover:bg-[linear-gradient(140deg,#fff_0%,#fff_100%)] hover:text-[#6e54b5] active:bg-[linear-gradient(140deg,#fff_0%,#fff_100%)] active:text-[#6e54b5]"
          >
