          ...
          >
            {NAV.map((item) => (
              <a
                ...
                className="flex h-[3.25rem] items-center justify-center gap-2.5 rounded-[0.75rem] text-[1.0625rem] font-semibold uppercase text-white transition hover:bg-[#222222]"
              >
                {item.label}
              </a>
            ))}
